...
\texttt{pdf} [\texttt{@} \textit{fn-name}$|$\textit{addx}] & disassemble function \textit{fn-name}/at \textit{addx} \\
\texttt{pdc} [\texttt{@} \textit{fn-name}$|$\textit{addx}] & pseudo-disassemble in C-like syntax
\end{tabular}
