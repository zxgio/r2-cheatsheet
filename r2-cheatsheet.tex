...
\texttt{dbg.slow} & show stack and regs in visual mode, in a slow but \\ & verbose (e.g. telescoping) mode \\
\\
...
\end{tabular} \\
Note: to get your \textit{name}s appear in disassembly, you must include a prefix (\texttt{fun}, \texttt{sub}, \texttt{obj}, \ldots)
% ; e.g. \texttt{f obj.foo @ 0x1234}
or define your own flagspace.
